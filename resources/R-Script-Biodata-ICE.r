...
out.bio.phd <- "C:\\MeineHomepage\\docs\\data/biodata phd.txt"
out.can <- "C:\\MeineHomepage\\docs\\data/biodata ice canada.txt"
out.ind <- "C:\\MeineHomepage\\docs\\data/biodata ice india.txt"
out.ire <- "C:\\MeineHomepage\\docs\\data/biodata ice ireland.txt"
out.gb <- "C:\\MeineHomepage\\docs\\data/biodata ice gb r2.txt"
out.jam <- "C:\\MeineHomepage\\docs\\data/biodata ice jamaica.txt"
out.nz <- "C:\\MeineHomepage\\docs\\data/biodata ice new zealand.txt"
out.phi <- "C:\\MeineHomepage\\docs\\data/biodata ice philippines.txt"
out.sbc <- "C:\\MeineHomepage\\docs\\data/biodata sbcae.txt"
###############################################################
###############################################################
