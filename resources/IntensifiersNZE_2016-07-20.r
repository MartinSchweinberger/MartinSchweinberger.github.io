...
### --- Schweinberger, Martin. 2016. "Intensifiers in New Zealand English", unpublished R script, Hamburg University.
###############################################################
###                   START
###############################################################
...
imageDirectory<-"C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images"
...
write.table(df2, "C:\\03-MyProjects\\07IntensifiersNZE\\Article/datadf.txt", sep = "\t", row.names = F, col.names = T)
# read data for pos tagging
df2 <- read.table("C:\\03-MyProjects\\07IntensifiersNZE\\Article/datadf.txt", sep = "\t", header = T)
...
#writeLines(irepos01, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos01.txt", sep = "\n", useBytes = FALSE)
# chunk 2
#irepos02 <- POStag(object = pos02)
#irepos02 <- as.vector(unlist(irepos02))
#writeLines(irepos02, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos02.txt", sep = "\n", useBytes = FALSE)
# chunk 03
#irepos03 <- POStag(object = pos03)
#irepos03 <- as.vector(unlist(irepos03))
#writeLines(irepos03, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos03.txt", sep = "\n", useBytes = FALSE)
# chunk 04
#irepos04 <- POStag(object = pos04)
#irepos04 <- as.vector(unlist(irepos04))
#writeLines(irepos04, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos04.txt", sep = "\n", useBytes = FALSE)
# chunk 05
#irepos05 <- POStag(object = pos05)
#irepos05 <- as.vector(unlist(irepos05))
#writeLines(irepos05, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos05.txt", sep = "\n", useBytes = FALSE)
# chunk 06
#irepos06 <- POStag(object = pos06)
#irepos06 <- as.vector(unlist(irepos06))
#writeLines(irepos06, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos06.txt", sep = "\n", useBytes = FALSE)
# chunk 07
#irepos07 <- POStag(object = pos07)
#irepos07 <- as.vector(unlist(irepos07))
#writeLines(irepos07, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos07.txt", sep = "\n", useBytes = FALSE)
# chunk 08
#irepos08 <- POStag(object = pos08)
#irepos08 <- as.vector(unlist(irepos08))
#writeLines(irepos08, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos08.txt", sep = "\n", useBytes = FALSE)
# chunk 09
#irepos09 <- POStag(object = pos09)
#irepos09 <- as.vector(unlist(irepos09))
#writeLines(irepos09, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos09.txt", sep = "\n", useBytes = FALSE)
# chunk 10
#irepos10 <- POStag(object = pos10)
#irepos10 <- as.vector(unlist(irepos10))
#writeLines(irepos10, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos10.txt", sep = "\n", useBytes = FALSE)
# chunk 11
#irepos11 <- POStag(object = pos11)
#irepos11 <- as.vector(unlist(irepos11))
#writeLines(irepos11, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos11.txt", sep = "\n", useBytes = FALSE)
# chunk 12
#irepos12 <- POStag(object = pos12)
#irepos12 <- as.vector(unlist(irepos12))
#writeLines(irepos11, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos12.txt", sep = "\n", useBytes = FALSE)
# chunk 13
#irepos13 <- POStag(object = pos13)
#irepos13 <- as.vector(unlist(irepos13))
#writeLines(irepos13, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos13.txt", sep = "\n", useBytes = FALSE)
# chunk 14
#irepos14 <- POStag(object = pos14)
#irepos14 <- as.vector(unlist(irepos14))
#writeLines(irepos14, con = "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos14.txt", sep = "\n", useBytes = FALSE)
# list pos tagged elements
postag.files = c("C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos01.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos02.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos03.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos04.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos05.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos06.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos07.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos08.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos09.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos10.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos11.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos12.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos13.txt",
  "C:\\03-MyProjects\\07IntensifiersNZE\\Article/irepos14.txt")
...
intensifiers <- c("absolutely", "actually", "aggressively", "amazingly",
  ...
  "purely", "real", "really", "remarkably", "right", "seriously", "shocking",
  "significant", "significantly", "so", "specially", "specifically", "strikingly",
  "strongly", "super", "surely", "terribly", "terrifically", "too", "total",
...
df4$remove <- as.vector(unlist(sapply(df4$pint, function(x){
  ifelse(x =="not", "remove",
  ifelse(x =="n't", "remove",
  ifelse(x =="no", "remove", x)))
  } )))
...
write.table(data, "C:\\03-MyProjects\\07IntensifiersNZE/dataNZE.txt", row.names=F, sep="\t")
...
rmv <- c("above", "absorbing", "abused", "accessory", "acoustic", "acting", "adrian",
  ...
  "athlete", "audio", "augsburg", "australia", "avanti", "awa", "awkwardly", "ayrton",
  ...
  "ellipse", "else", "embassy", "emperor", "ensemble", "entrepreneurial",  "environmental",
  "enzac", "epuni", "evidentiary", "fairer", "fairy", "fale", "falsehood", "fanta",
  ...
  "muldoonist", "multi", "mum", "munich", "muriwai", "nah", "nanny", "narrower", "nat",
  ...
  "organised", "otago", "ours", "outer", "overactive", "overall", "overseas", "overshadowed",
  ...
  "tigrean", "tim", "toughest", "tramping", "transmitter", "traversal", "treble", "tribal",
  ...
  "whakarewarewa", "whitbread", "whitianga", "wholehearted", "wholesale", "wholesome",
...
write.table(pinttb, "C:\\03-MyProjects\\07IntensifiersNZE\\Article/pinttb.txt", row.names = F, sep="\t")
...
# save data to disc
write.table(pinttb, "C:\\03-MyProjects\\07IntensifiersNZE\\Beamer/pinttb.txt", sep = "\t", row.names = F)
###############################################################
s1a <- data[data$txtyp == "PrivateDialogue", ]
...
# save data to disc
write.table(pinttbs1a, "C:\\03-MyProjects\\07IntensifiersNZE\\Beamer/pinttb_s1a.txt", sep = "\t", row.names = F)
###############################################################
...
# save data to disc
write.table("C:\\03-MyProjects\\07IntensifiersNZE\\Beamer/inttb01.txt", sep = "\t", row.names = F)
###############################################################
# pint by tt
mean.pinttt <- by(data$pint, list(data$txtyp), table)
pri <- mean.pinttt$PrivateDialogue[order(mean.pinttt$PrivateDialogue, decreasing = T)]
...
write.table(pinttb, "C:\\03-MyProjects\\07IntensifiersNZE\\Beamer/pinttb.txt", row.names = F, sep="\t")
###############################################################
###############################################################
###############################################################
###             VISUALIZATION
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/IntPrim.png", width = 480, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/IntSex.png", width = 480, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/IntFun.png", width = 480, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/IntTxtyp.png", width = 580, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/IntAge.png", width = 480, height = 480) # save plot
...
sem4<-sd4/sqrt(l50)*100
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/IntAgeS1A.png", width = 480, height = 480) # save plot
plot(c(int1624, int2539, int4049, int50), xlim = c(0.5, 4.5), axes = F, ylim = c(0, 20), xlab = "",
  ylab = "Percent of Intensified Pre-ADJ Slots", pch = 20)
# add axes
axis(1, seq(1,4,1), c("16-24", "25-39", "40-49", "50+"))
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/VeryAgeS1aOnlyInts.png", width = 480, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/reallyAgeS1aOnlyInts.png",
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/soAgeS1aOnlyInts.png",
  width = 480, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/TTRAgeS1aOnlyInts.png", width = 480, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/TAgeS1aOnlyInts.png", width = 480, height = 480) # save plot
...
tt <- as.matrix(tt)
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/FreqAgeS1aOnlyInts.png", width = 1000, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/PercentAgeS1aOnlyInts.png", width = 1000, height = 480) # save plot
...
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/PercentAgeS1aOnlyIntsLine.png",  width = 480, height = 480) # save plot
...
ttsel <- as.matrix(tt.age.tb.pc)
# plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/PercentAgeOrigS1aOnlyIntsLine.png",  width = 900, height = 480) # save plot
...
lexdivm <- as.vector(unlist(sapply(intyps, function(x){
  ...
  # plot
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/TTRIntsAdj.png", width = 750, height = 480) # save plot
...
badly  <- collex(data = t3, cv1 = 3)
clearly  <- collex(data = t3, cv1 = 4)
completely  <- collex(data = t3, cv1 = 5)
considerably  <- collex(data = t3, cv1 = 6)
decidedly  <- collex(data = t3, cv1 = 7)
definitely  <- collex(data = t3, cv1 = 8)
dreadfully  <- collex(data = t3, cv1 = 9)
enormously  <- collex(data = t3, cv1 = 10)
entirely  <- collex(data = t3, cv1 = 11)
especially  <- collex(data = t3, cv1 = 12)
exactly  <- collex(data = t3, cv1 = 13)
extraordinarily  <- collex(data = t3, cv1 = 14)
extremely  <- collex(data = t3, cv1 = 15)
firmly  <- collex(data = t3, cv1 = 16)
fully  <- collex(data = t3, cv1 = 17)
grossly  <- collex(data = t3, cv1 = 18)
highly  <- collex(data = t3, cv1 = 19)
horrendously  <- collex(data = t3, cv1 = 20)
immediately  <- collex(data = t3, cv1 = 21)
incredibly  <- collex(data = t3, cv1 = 22)
obviously  <- collex(data = t3, cv1 = 23)
particularly  <- collex(data = t3, cv1 = 24)
perfectly  <- collex(data = t3, cv1 = 25)
positively  <- collex(data = t3, cv1 = 26)
precisely  <- collex(data = t3, cv1 = 27)
pretty  <- collex(data = t3, cv1 = 28)
purely  <- collex(data = t3, cv1 = 29)
really  <- collex(data = t3, cv1 = 30)
remarkably  <- collex(data = t3, cv1 = 31)
right  <- collex(data = t3, cv1 = 32)
seriously  <- collex(data = t3, cv1 = 33)
significantly  <- collex(data = t3, cv1 = 34)
so  <- collex(data = t3, cv1 = 35)
strongly  <- collex(data = t3, cv1 = 36)
surely  <- collex(data = t3, cv1 = 37)
terribly  <- collex(data = t3, cv1 = 38)
totally  <- collex(data = t3, cv1 = 39)
utterly  <- collex(data = t3, cv1 = 40)
very  <- collex(data = t3, cv1 = 41)
wholly  <- collex(data = t3, cv1 = 42)
# extract informaltion
absolutely <- matrix(unlist(absolutely),ncol=4,byrow=TRUE)
badly <- matrix(unlist(badly),ncol=4,byrow=TRUE)
clearly <- matrix(unlist(clearly),ncol=4,byrow=TRUE)
completely <- matrix(unlist(completely),ncol=4,byrow=TRUE)
considerably <- matrix(unlist(considerably),ncol=4,byrow=TRUE)
decidedly <- matrix(unlist(decidedly),ncol=4,byrow=TRUE)
definitely <- matrix(unlist(definitely),ncol=4,byrow=TRUE)
dreadfully <- matrix(unlist(dreadfully),ncol=4,byrow=TRUE)
enormously <- matrix(unlist(enormously),ncol=4,byrow=TRUE)
entirely <- matrix(unlist(entirely),ncol=4,byrow=TRUE)
especially <- matrix(unlist(especially),ncol=4,byrow=TRUE)
exactly <- matrix(unlist(exactly),ncol=4,byrow=TRUE)
extraordinarily <- matrix(unlist(extraordinarily),ncol=4,byrow=TRUE)
extremely <- matrix(unlist(extremely),ncol=4,byrow=TRUE)
firmly <- matrix(unlist(firmly),ncol=4,byrow=TRUE)
fully <- matrix(unlist(fully),ncol=4,byrow=TRUE)
grossly <- matrix(unlist(grossly),ncol=4,byrow=TRUE)
highly <- matrix(unlist(highly),ncol=4,byrow=TRUE)
horrendously <- matrix(unlist(horrendously),ncol=4,byrow=TRUE)
immediately <- matrix(unlist(immediately),ncol=4,byrow=TRUE)
incredibly <- matrix(unlist(incredibly),ncol=4,byrow=TRUE)
obviously <- matrix(unlist(obviously),ncol=4,byrow=TRUE)
particularly <- matrix(unlist(particularly),ncol=4,byrow=TRUE)
perfectly <- matrix(unlist(perfectly),ncol=4,byrow=TRUE)
positively <- matrix(unlist(positively),ncol=4,byrow=TRUE)
precisely <- matrix(unlist(precisely),ncol=4,byrow=TRUE)
pretty <- matrix(unlist(pretty),ncol=4,byrow=TRUE)
purely <- matrix(unlist(purely),ncol=4,byrow=TRUE)
really <- matrix(unlist(really),ncol=4,byrow=TRUE)
remarkably <- matrix(unlist(remarkably),ncol=4,byrow=TRUE)
right <- matrix(unlist(right),ncol=4,byrow=TRUE)
seriously <- matrix(unlist(seriously),ncol=4,byrow=TRUE)
significantly <- matrix(unlist(significantly),ncol=4,byrow=TRUE)
so <- matrix(unlist(so),ncol=4,byrow=TRUE)
strongly <- matrix(unlist(strongly),ncol=4,byrow=TRUE)
surely <- matrix(unlist(surely),ncol=4,byrow=TRUE)
terribly <- matrix(unlist(terribly),ncol=4,byrow=TRUE)
totally <- matrix(unlist(totally),ncol=4,byrow=TRUE)
utterly <- matrix(unlist(utterly),ncol=4,byrow=TRUE)
very <- matrix(unlist(very),ncol=4,byrow=TRUE)
wholly <- matrix(unlist(wholly),ncol=4,byrow=TRUE)
# set up table with results
collextab <- rbind(absolutely, badly, clearly, completely, considerably, decidedly,
  definitely, dreadfully, enormously, entirely, especially, exactly, extraordinarily,
  extremely, firmly, fully, grossly, highly, horrendously, immediately, incredibly,
  obviously, particularly, perfectly, positively, precisely, pretty, purely, really,
  remarkably, right, seriously, significantly, so, strongly, surely, terribly, totally,
  utterly, very, wholly)
...
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/RIntsAdjRev.png", width = 1520, height = 580) # save plot
...
adjpinttokensdf02 <- adjpinttokensdf02[2:nrow(adjpinttokensdf02),]
# plot ratio of intensifiertokens against intensified adjective types
png("C:\\03-MyProjects\\07IntensifiersNZE\\Article\\images/RIntsAdj.png", width = 1520, height = 580) # save plot
...
write.table(blrm.really, "C:\\03-MyProjects\\07IntensifiersNZE\\Article/blrm_really.txt", sep="\t")
